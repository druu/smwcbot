defmodule SMWCBotBlocksTest do
  ...
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:blocks, 0)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!blocks what the eff", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:blocks, 1)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!blocks redeeming peach", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:blocks, 2)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!blocks foo", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:blocks, "multi-page")}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!blocks mario", sender, chat)
  #   end
