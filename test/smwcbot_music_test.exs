defmodule SMWCBotMusicTest do
  ...
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:music, 0)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!nusic what the eff", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:music, 1)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!nusic redeeming peach", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:music, 2)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!nusic foo", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:music, "multi-page")}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!nusic mario", sender, chat)
  #   end
