defmodule SMWCBotGraphicsTest do
  ...
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:graphics, 0)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!graphics what the eff", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:graphics, 1)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!graphics redeeming peach", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:graphics, 2)}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!graphics foo", sender, chat)
  #   end
  ...
  #     expect(Mojito, :get, fn _uri ->
  #       {:ok, %{status_code: 200, body: HTMLBodies.smwc_results(:graphics, "multi-page")}}
  #     end)
  ...
  #     assert :ok = SMWCBot.handle_message("!graphics mario", sender, chat)
  #   end
